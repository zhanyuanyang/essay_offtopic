...
#获取当前路径
path = os.getcwd()+'/algorithm/OffTopic/KeyWord/LDA'
...
# print os.getcwd()
conf.read(os.getcwd()+"/algorithm/OffTopic/setting.conf")
#文件路径
...
def filein():
    with codecs.open('algorithm/OffTopic/KeyWord/LDA/data/model_phi.dat', 'r', 'utf-8') as f:
        docs1 = f.readlines()
